...
# define YYTOKENTYPE
  enum yytokentype
  {
    ...
    TOKEN_RR = 265,                /* TOKEN_RR  */
    TOKEN_RL = 266,                /* TOKEN_RL  */
    TOKEN_BRANCH = 267,            /* TOKEN_BRANCH  */
    TOKEN_JUMP = 268,              /* TOKEN_JUMP  */
    TOKEN_JUMP_LINK = 269,         /* TOKEN_JUMP_LINK  */
    TOKEN_MOVE = 270,              /* TOKEN_MOVE  */
    TOKEN_LOAD_DIRECT = 271,       /* TOKEN_LOAD_DIRECT  */
    TOKEN_LOAD_IMMEDIATE = 272,    /* TOKEN_LOAD_IMMEDIATE  */
    TOKEN_LOAD_INDEXED = 273,      /* TOKEN_LOAD_INDEXED  */
    TOKEN_STORE_DIRECT = 274,      /* TOKEN_STORE_DIRECT  */
    TOKEN_STORE_INDEXED = 275,     /* TOKEN_STORE_INDEXED  */
